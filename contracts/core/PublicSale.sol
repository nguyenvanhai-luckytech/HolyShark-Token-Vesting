...
contract PublicSale is BEP20, AccessControl, ReentrancyGuard {
    ...
    function _getVestingClaimableAmount(
        ...
        if (block.timestamp >= releaseTime) {
            if(vestingTypeInfo.arbitrary) {
                ...
                roundReleasedAmount = _calculateReleaseAmount(releaseTime, tgeReleasedAmount, vestingTypeInfo, info);
            }
        }
